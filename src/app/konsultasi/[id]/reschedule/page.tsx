...
export default function RescheduleKonsultasiPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setError(error.response?.data?.message || 'Gagal mengubah jadwal konsultasi. Silakan coba lagi.');
    } finally {
      setSubmitting(false);
    }
  };
      ...
      <ProtectedRoute allowedRoles={['PACILIAN', 'CAREGIVER']} requiredService="konsultasi">
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">
              Konsultasi Tidak Dapat Diubah
            </h2>
            <p className="text-gray-600 mb-4">
              Hanya konsultasi dengan status "Menunggu Konfirmasi" yang dapat diubah jadwalnya.
            </p>
            <button
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Catatan ini akan membantu dokter memahami alasan perubahan
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
                ...
                >
                  {submitting ? 'Mengubah Jadwal...' : 'Ubah Jadwal'}
                </button>

                <p className="text-xs text-gray-500 mt-3 text-center">
                  Perubahan jadwal perlu persetujuan dari dokter
                </p>

                <div className="mt-6 pt-6 border-t border-gray-200">
                  <h4 className="font-medium text-gray-900 mb-3">Informasi</h4>
                  <div className="space-y-2 text-sm text-gray-600">
                    <p>• Perubahan jadwal akan masuk status "Menunggu Persetujuan"</p>
                    <p>• Dokter dapat menerima atau menolak perubahan</p>
